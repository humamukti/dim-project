        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Form Input Bagian Baru</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
{{--        <form class="form d-flex flex-column flex-lg-row" action="{{ route('roles.store') }}" method="post">--}}
            {!! Form::open(array('route' => 'roles.store','method'=>'POST', 'class' => 'form d-flex flex-column flex-lg-row')) !!}
            @csrf
                        ...
                        <div class="mb-10">
                            ...
                            <div class="d-flex flex-column fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-5">
                                    <!--begin::Input-->
                                    {{ Form::checkbox('permission[]', $value->id, false, array('class' => 'form-check-input me-3')) }}
                                    <!--end::Input-->
