                ...
                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                    ...
                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center h-md-50 mb-5 mb-xl-10" style="background-color: #080655;background-image:url('assets/media/svg/shapes/wave-bg-dark.svg')">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <!--end::Amount-->
                                <!--begin::Subtitle-->
                                <span class="text-white opacity-50 pt-1 fw-bold fs-6">Pekerjaan Aktif</span>
                                <!--end::Subtitle-->
                            </div>
                            <!--end::Title-->
                        </div>
                    ...
                    <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                <!--begin::Amount-->
                                <span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2">27</span>
                                <!--end::Amount-->
                                <!--begin::Subtitle-->
                                <span class="text-gray-400 pt-1 fw-bold fs-6">Staff Aktif</span>
                                <!--end::Subtitle-->
                            </div>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-end pe-0">
                            <!--begin::Title-->
                            <span class="fs-6 fw-boldest text-gray-800 d-block mb-2">Online Hari Ini</span>
                            <!--end::Title-->
                            <!--begin::Users group-->
                            <div class="symbol-group symbol-hover flex-nowrap">
                                ...
                                <a href="#" class="symbol symbol-35px symbol-circle" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">
                                    <span class="symbol-label bg-dark text-gray-300 fs-8 fw-bolder">+15</span>
                                </a>
                            </div>
                            <!--end::Users group-->
                        </div>
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Currency-->
                                    <!--begin::Amount-->
                                    <span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2">79,7</span>
                                    <!--end::Amount-->
                                    <!--begin::Badge-->
                                ...
                                <!--end::Info-->
                                <!--begin::Subtitle-->
                                <span class="text-gray-400 pt-1 fw-bold fs-6">Projek di Bulan April</span>
                                <!--end::Subtitle-->
                            </div>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card-body pt-2 pb-4 d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column content-justify-center w-100">
                                ...
                                <div class="d-flex fw-bold align-items-center">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-boldest text-gray-700 text-xxl-end">33%</div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                                <!--begin::Label-->
                                <div class="d-flex fw-bold align-items-center my-3">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">Mobile App</div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-boldest text-gray-700 text-xxl-end">23%</div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                                <!--begin::Label-->
                                <div class="d-flex fw-bold align-items-center">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-boldest text-gray-700 text-xxl-end">44%</div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                            </div>
                    ...
                    <div class="card card-flush h-lg-50">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <div class="text-gray-700 fw-bold fs-6 me-2">Avg. Kinerja</div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <div class="text-gray-700 fw-bold fs-6 me-2">Avg. Permasalahan</div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                                <div class="d-flex align-items-senter">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <div class="text-gray-700 fw-bold fs-6 me-2">Avg. Absensi</div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                                <div class="d-flex align-items-senter">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr094.svg-->
                                    ...
                                    <!--end::Svg Icon-->
                                    <!--begin::Number-->
                                    <span class="text-gray-900 fw-boldest fs-6">88%</span>
                                    <!--end::Number-->
                                </div>
                                <!--end::Statistics-->
                            </div>
                    ...
                    <div class="card h-md-100">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-bold fs-7">Total 112 projek tersampaikan</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card h-md-100">
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                <!--begin::Title-->
                                <h1 class="fw-bold text-gray-800 text-center lh-lg">Membuat
                                    <br />
                                    <span class="fw-boldest">Agenda Baru</span></h1>
                                <!--end::Title-->
                                <!--begin::Illustration-->
                            ...
                            <div class="text-center mb-1">
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-primary me-2" data-bs-target="#kt_modal_new_address" data-bs-toggle="modal">Buat</a>
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="#">Report</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card h-md-100">
                        ...
                        <div class="card-header position-relative py-0 border-bottom-1">
                            <!--begin::Card title-->
                            <h3 class="card-title text-gray-800 fw-bolder">Timeline Aktif</h3>
                            <!--end::Card title-->
                            <!--begin::Tabs-->
