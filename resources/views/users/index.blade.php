        ...
        <div class="card card-flush">
            ...
            <div class="card-header mt-6">
                ...
                <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a class="btn btn-light-primary" href="{{ route('users.create') }}">
                    ...
                    @foreach ($data as $key => $user)
                        <tr>
                            ...
                            <td class="text-end">
                                <!--begin::Update-->
                                @can('product-edit')
                                    <a class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" href="{{ route('users.edit',$user->id) }}">
